...
export const Eagle: React.FC<{ playerId?: number, throttle?: number }> = ({ playerId = 1, throttle }) => {
  ...
  return (
     <group scale={[0.38, 0.38, 0.38]}>
        ...
        <group position={[0, 0, -1.6]}>
            <JetExhaust color="#ef4444" scale={0.8} length={3.0} throttle={effectiveThrottle} />
        </group>
        <group position={[0.7, 0, -1.6]}>
            <JetExhaust color="#ef4444" scale={0.6} length={2.5} throttle={effectiveThrottle} />
        </group>
        <group position={[-0.7, 0, -1.6]}>
            <JetExhaust color="#ef4444" scale={0.6} length={2.5} throttle={effectiveThrottle} />
        </group>
