...
export const Falcon: React.FC<{ playerId?: number, throttle?: number }> = ({ playerId = 1, throttle }) => {
  ...
  return (
     <group scale={[0.35, 0.35, 0.35]}>
        ...
        <group position={[0, 0.2, -1.8]}>
            <JetExhaust color="#38bdf8" scale={1.1} length={3.0} throttle={effectiveThrottle} />
        </group>
     </group>
  );
};
