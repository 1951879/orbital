...
export const Bomber: React.FC<{ playerId?: number, throttle?: number }> = ({ playerId = 1, throttle }) => {
  ...
  return (
     <group scale={[0.4, 0.4, 0.4]}>
        ...
        <group position={[1.2, -0.2, -0.8]}>
            <JetExhaust color={colors.highlight} scale={1.4} length={4.0} throttle={effectiveThrottle} />
        </group>
        <group position={[-1.2, -0.2, -0.8]}>
            <JetExhaust color={colors.highlight} scale={1.4} length={4.0} throttle={effectiveThrottle} />
        </group>
