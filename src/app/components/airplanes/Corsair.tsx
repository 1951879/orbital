...
export const Corsair: React.FC<{ playerId?: number, throttle?: number }> = ({ playerId = 1, throttle }) => {
  ...
  return (
     <group scale={[0.35, 0.35, 0.35]}>
        ...
        <group position={[0, 0, -1.6]}>
            <JetExhaust color={colors.main} scale={1.0} length={3.0} throttle={effectiveThrottle} />
        </group>
     </group>
  );
};
