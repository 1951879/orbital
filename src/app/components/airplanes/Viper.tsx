...
export const Viper: React.FC<{ playerId?: number, throttle?: number }> = ({ playerId = 1, throttle }) => {
  ...
  return (
     <group scale={[0.35, 0.35, 0.35]}>
        ...
        <group position={[0, 0, -1.1]}>
            <JetExhaust color="#ff0000" scale={1.3} length={3.5} throttle={effectiveThrottle} />
        </group>
     </group>
  );
};
